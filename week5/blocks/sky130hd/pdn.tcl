...
set_voltage_domain -region {analog_async_up_down} -power {VDD} -ground {VSS} -secondary_power VIN
####################################
# standard cell grid
####################################
...
####################################
define_pdn_grid -name stdcell_analog1  -starts_with POWER -voltage_domains analog_async_up_down -pins {met3}
