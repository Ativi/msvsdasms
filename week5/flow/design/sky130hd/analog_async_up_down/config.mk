...
export ADDITIONAL_LEFS  	= ../blocks/$(PLATFORM)/lef/ONEBITADC_0.lef \
                        	  ../blocks/$(PLATFORM)/lef/RINGOSC_0.lef

export ADDITIONAL_GDS_FILES 	= ../blocks/$(PLATFORM)/gds/ONEBITADC_0.gds \
			      	  				../blocks/$(PLATFORM)/gds/RINGOSC_0.gds
