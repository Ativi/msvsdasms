...
parser = argparse.ArgumentParser(description="analog_async_up_down design generator")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "analog_async_up_down-gen":
    print('Error: Generator specification must be "analog_async_up_down-gen".')
    sys.exit(1)
...
mFilePublic1 = genDir + args.platform + ".model_analog_async_up_down"
