...
srcDir = genDir + "src/"
flowDir = genDir + "flow/"
designDir = genDir + "designs/src/analog_async_up_down/"
simDir = genDir + "simulations/"
commonDir = genDir + "../../common/"
platformDir = genDir + "../../common/platforms/" + args.platform + "/"
objDir = flowDir + "objects/" + args.platform + "/analog_async_up_down/"
...
shutil.copyfile(srcDir + "analog_async_up_down.v", flowDir + "design/src/analog_async_up_down/analog_async_up_down" + ".v")
...
#  subprocess.run(["ls", "-l", flowDir, "results/", args.platform, "/analog_async_up_down"])

shutil.copyfile(
    flowDir + "results/" + args.platform + "/analog_async_up_down/6_final.gds",
    outputDir + "/" + designName + ".gds",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/analog_async_up_down/6_final.def",
    outputDir + "/" + designName + ".def",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/analog_async_up_down/6_final.v",
    outputDir + "/" + designName + ".v",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/analog_async_up_down/6_1_fill.sdc",
...
shutil.copyfile(
    flowDir + "reports/" + args.platform + "/analog_async_up_down/6_final_drc.rpt",
    outputDir + "/6_final_drc.rpt",
)
shutil.copyfile(
    flowDir + "reports/" + args.platform + "/analog_async_up_down/6_final_lvs.rpt",
